...
namespace XComponent.SliderBar
{
	...
	{	
		...
		[Category("Appearance")]
		[Description("Gets or sets the color of the track line below the tracker.")]
		public Color TrackLineColorMin
		{
			get { return _trackLineColorMin; }
			set 
			{
				if( value != _trackLineColorMin)
				{
					_trackLineColorMin = value;
					Invalidate(); 
				}
			}
		}
        ...
        public Color TrackLineColorMax
        {
            get { return _trackLineColorMax; }
            set
            {
                if (value != _trackLineColorMax)
                {
                    _trackLineColorMax = value;
                    Invalidate();
                }
            }
        }
		...
		{
			DrawMACStyleHelper.DrawAquaPillSingleLayer(
                g, 
                drawRect,
                trackerRect,
                _trackLineColorMin,
